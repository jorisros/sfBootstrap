...
<?php if ($field->isReal() || $field->getConfig('is_sortable', false, false)): ?>
  [?php if ('<?php echo $name ?>' == $sort[0]): ?]
    ...
    [?php if ('asc' == $sort[1]): ?]
      <span class="glyphicon glyphicon-sort-by-alphabet" aria-hidden="Center Align"></span>
    [?php endif; ?]
    [?php if ('desc' == $sort[1]): ?]
      <span class="glyphicon glyphicon-sort-by-alphabet-alt" aria-hidden="Center Align"></span>
    [?php endif; ?]
  [?php else: ?]
